...
public interface PersonalRecDao {
     ...
     * @param songId 歌曲id
     */
    void insertRecA(Integer userId, Integer songId);
     ...
     * @param songId 歌曲id
     */
    void insertRecB(Integer userId, Integer songId);
     ...
     *
     * @param songList 包含歌曲Id的信息列表
     * @param userId   用户的Id
     */
    void insertListIntoRecA(List<Song> songList, Integer userId);
     ...
     * @param userId   用户的Id
     */
    void insertListIntoRecB(List<Song> songList, Integer userId);
