...
<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color: #e3f2fd;">
    <a class="navbar-brand" href="${pageContext.request.contextPath}/index.do">音乐推荐平台</a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <form class="form-inline mt-2 mt-md-0" id="searchFormId">
            ...
            <input class="form-control mr-sm-2" id="searchInputId" type="text" placeholder="输入想找的音乐..."
                   aria-label="Search" name="keyword" required autofocus oninvalid="this.setCustomValidity('搜索内容不能为空')"
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown" <c:if test="${sessionScope.user!=null}">style="display:none;"</c:if>>
                <a class="btn btn-primary btn-block" href="#" id="navbarDropdown"
                   role="button" aria-haspopup="true"
                   aria-expanded="false" data-toggle="modal" data-target="#SignInModalCenter">
                 登录
                </a>
            </li>
            <li class="nav-item dropdown" <c:if test="${sessionScope.user!=null}">style="display:none;"</c:if>><a
                    class="btn btn-success btn-block" href="#" id="navbarDropdown"
                    role="button" aria-haspopup="true"
